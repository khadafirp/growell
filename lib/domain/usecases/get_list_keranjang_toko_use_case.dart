...
class GetListKeranjangTokoUseCase{
  final KeranjangProdukRepository repository;

  GetListKeranjangTokoUseCase(this.repository);

  @override
  Future<Either<ListKeranjangTokoModel, Error>> call() async {
    return await repository.getListKeranjangToko();
  }
}
