...
class DetailRiwayatTransaksiUseCase{
  final RiwayatTransaksiRepository repository;

  DetailRiwayatTransaksiUseCase(this.repository);

  @override
  Future<Either<DetailRiwayatTransaksiModel, Error>> call({required DetailRiwayatTransaksiDTO params}) async {
    return await repository.detailRiwayatTransaksi(params);
  }
}
